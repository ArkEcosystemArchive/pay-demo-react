...
class App extends React.Component {
  ...
  countdown() {
    ...
    const calculate = () => {
      ...
      this.setState(state => {
        ...
        state.timeMinutes = Math.floor(state.timeLeft / 60);
        state.timeSeconds = state.timeLeft % 60;
  ...
  scanLink() {
    return `ark:${this.state.recipient}?amount=${
              ...
              {this.state.method === "address" ? (
                <div>
                  <div className="mt-3 pb-3 border-b-2 border-dashed">
                    ...
                    <span className="font-bold">Surprise GIF</span>
                  </div>
                  ...
                  <div className="mt-3 pb-3 border-b-2 border-dashed">
                    ...
                    <span className="font-bold">
                      ...
                      <a href="#" className="clipboard float-right animated">
                        <img
                          onClick={this.copyToClipboard.bind(this, "recipient")}
                  ...
                  <div className="mt-3 pb-3 border-b-2 border-dashed">
                    ...
                    <span className="font-bold block pt-1">
                      <span className="currency font-hairline rounded text-sm mr-2 px-2 py-1">
                        DѦ
                      </span>
                      {this.state.amountCrypto}
                      <span className="fiat font-normal">
                        / ${this.state.amount}
                      </span>
                      <a href="#" className="clipboard float-right animated">
                        <img
              ...
              <div className="flex flex-no-wrap">
                <div className="w-3/4 flex-none">
                  ...
                  <span className="inline-block pl-3">
                    ...
                    <span>
                      <span className="waiting text-sm font-light">
                ...
                <div className="w-1/4 flex-none pt-6">
                  <a
                    href={this.scanLink()}
                    className="pay-button text-sm font-bold p-3 no-underline rounded float-right"
                  >
                    Pay Now
                  </a>
                </div>
